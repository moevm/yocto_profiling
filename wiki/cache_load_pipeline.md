```bash
user@yadrolab-wp1:~/os_profiling/src/yocto-build$ docker-compose up ; docker logs yocto_project --follow
[+] Running 1/0
 ✔ Container yocto_project  Created                                                                                                                                                                                        0.0s 
Attaching to yocto_project
yocto_project  | 
yocto_project  | ### Shell environment set up for builds. ###
yocto_project  | 
yocto_project  | You can now run 'bitbake <target>'
yocto_project  | 
yocto_project  | Common targets are:
yocto_project  |     core-image-minimal
yocto_project  |     core-image-full-cmdline
yocto_project  |     core-image-sato
yocto_project  |     core-image-weston
yocto_project  |     meta-toolchain
yocto_project  |     meta-ide-support
yocto_project  | 
...
yocto_project  | 
yocto_project  | AAAAAAAAAAAAAAAAAAAAAAAAAA
yocto_project  | 
yocto_project  | BBBBBBBBBBBBBBBBBBBB 
yocto_project  | 
yocto_project  | C--C--C--C--C--C--C--C--C--C--C--C--C--C--C--C--C--C--C--C-- 
yocto_project  | 
yocto_project  | DDDDDDDDDDDDDDDDDDDD 
yocto_project  | 
yocto_project  | EEEEEEEEEEEEEEEEEEEE 
yocto_project  | 
yocto_project  | FFFFFFFFFFFFFFFFFFFF 
yocto_project  | 
yocto_project  | GGGGGGGGGGGGGGGGGGGG 
yocto_project  | 
yocto_project  | 
yocto_project  | Loading cache...
yocto_project  | done.
yocto_project  | Loaded 1845 entries from dependency cache.
yocto_project  | NOTE: Resolving any missing task queue dependencies
yocto_project  | 
yocto_project  | Build Configuration:
yocto_project  | BB_VERSION           = "2.6.0"
...
yocto_project  | DISTRO_VERSION       = "4.3.3"
yocto_project  | TUNE_FEATURES        = "m64 core2"
yocto_project  | TARGET_FPU           = ""
yocto_project  | meta                 
yocto_project  | meta-poky            
yocto_project  | meta-yocto-bsp       = "my-nanbield:51556868f6919df5349dbbb8c2a366ccd5bf76d0"
yocto_project  | 
yocto_project  | 
yocto_project  | Initialising tasks...
yocto_project  | done.
yocto_project  | Sstate summary: Wanted 1 Local 0 Mirrors 0 Missed 1 Current 2312 (0% match, 99% complete)
yocto_project  | NOTE: Executing Tasks
yocto_project  | NOTE: Tasks Summary: Attempted 4897 tasks of which 4897 didn't need to be rerun and all succeeded.
```
