...
1. Поиск в `go-build` по рассчитанному значению
...
# Java
В этом языке есть аналог файлов контроля зависимостей и метаданных проекта - `pom.xml`. Хоть язык компилируемый, зависимости кэшируют аналогично [предыдущему языку](#Node.js).